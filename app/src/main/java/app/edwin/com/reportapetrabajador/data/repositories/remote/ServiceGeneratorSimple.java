package app.edwin.com.reportapetrabajador.data.repositories.remote;
...
import app.edwin.com.reportapetrabajador.data.repositories.remote.deserializador.DateDeserializer;
...
public class ServiceGeneratorSimple {
    ...
    public ReporteRequest ConexionRestApi(Gson gson) {
        // Creamos un constructor Retrofit
        Retrofit retrofit = new Retrofit.Builder()
                // recibe url base a la que se conecta
                .baseUrl("http://rockenwebperu.com/semaforo/v1/")
